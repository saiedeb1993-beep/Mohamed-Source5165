                        ...
                        for (int x = 0; x < Order.Length; x++)
                        {
                            ...
                            if (OldPosition != nobilityclient.Position)
                            {
                                ...
                                if (nobilityclient.Rank > OldRank)
                                {
                                    ...
                                    {
                                        Program.SendGlobalPackets.Enqueue(new Game.MsgServer.MsgMessage(nobilityclient.Name + " has been promoted to " + nobilityclient.Rank.ToString() + ".", "ALL", Game.MsgServer.MsgMessage.MsgColor.white, Game.MsgServer.MsgMessage.ChatMode.Center).GetArray(stream));
                                    }
                                }
                            }
                        }
