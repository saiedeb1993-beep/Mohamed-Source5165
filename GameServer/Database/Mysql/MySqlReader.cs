...
namespace COServer.Database
{
    public unsafe class MySqlReader : IDisposable
    {
        ...
        public const string connectionString = "Server=localhost;Port=3306;Database=zq;Uid=root;Password=01180368150;Persist Security Info=True;Pooling=true; Min Pool Size = 32;  Max Pool Size = 300;";
