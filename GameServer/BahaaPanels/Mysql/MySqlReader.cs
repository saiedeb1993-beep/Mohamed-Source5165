...
namespace COServer.Database
{
    public unsafe class MySqlReader : IDisposable
    {
        ...
        public const string connectionString = "Server=localhost;Port=3306;Database=cq;Uid=root;Password=11112222;Persist Security Info=True;Pooling=true; Min Pool Size = 32;  Max Pool Size = 300;";
