...
namespace MaTrixAICore
{
    ...
    public sealed class IniFile
    {
        ...
        public sealed class IniFileSection
        {
            ...
            /// </summary>
            private SafeDictionary<string, string> entries;
            /// <summary>
            ...
            {
                entries = new SafeDictionary<string, string>();
                Name = name;
            }
        ...
        /// </summary>
        private SafeDictionary<string, IniFileSection> sections;
        ...
        {
            FileName = fileName;
            sections = new SafeDictionary<string, IniFile.IniFileSection>();
        }
